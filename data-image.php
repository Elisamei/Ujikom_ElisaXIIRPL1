...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <p><a href="tambah-image.php"><button class="btn"  style="background-color: #de5f90; color: #fff;">Tambah Data</button></a></p> <br/>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="edit-image.php?id=<?php echo $row['foto_id'] ?>"><button style="padding: 8px 10px; background-color: #f999; color:  #de5f7d; border: none; cursor: pointer;">Edit</button></a> || 
                              <a href="proses-hapus.php?idp=<?php echo $row['foto_id'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')"><button style="padding: 8px 10px; background-color:  #de5f7d; color: white; border: none; cursor: pointer;">Hapus</button></a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
